...
//Описывает кредит, который имеет годовую процентную ставку,
// количество лет и сумму кредита
//Расчитывает ежемесячный платеж и общую стоимость кредита на основе заданных параметров.
